        ...
        withMaven(maven: 'maven3') {
          script {
            if (params.DEPLOY_IN_PROD) {
              ...
              sh 'docker-compose -f docker-compose.yml -f docker-compose-prod.yml --env-file ./environments/.env.prod up -d --no-deps --build  --force-recreate  --force-recreate prod-api'
            } else {
              echo "deploying in prod : ${params.DEPLOY_IN_PROD}"
